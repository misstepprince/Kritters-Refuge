...
# Kritters: only displayed for Novakin analyzer states.
health-analyzer-window-entity-integrity-text = Integrity:
# Kritters: only displayed for Novakin analyzer states.
health-analyzer-window-entity-gas-type-text = Gas Type:
