...
public abstract partial class SharedVehicleSystem : EntitySystem
{
    ...
    [Dependency] private INetManager _net = default!; // _CS
    [Dependency] private UnpoweredFlashlightSystem _flashlight = default!; // _CS
    [Dependency] private SharedPopupSystem _popup = default!; // _CS
    [Dependency] private ActionBlockerSystem _actionBlocker = default!; // _CS
    [Dependency] private ActionContainerSystem _actionContainer = default!; // _CS
    [Dependency] private IGameTiming _timing = default!; // _CS
    [Dependency] private EmagSystem _emag = default!; // _CS
    [Dependency] private MovementSpeedModifierSystem _movespeed = default!; // _CS
    [Dependency] private SharedStunSystem _stun = default!; // _CS
    [Dependency] private ThrowingSystem _throwing = default!; // _CS
    [Dependency] private SharedPhysicsSystem _physics = default!; // _CS
